...
import com.dev.spendwise.databinding.ActivityAddExpenseNewBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import java.util.*

class AddExpenseNew : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    var binding: ActivityAddExpenseNewBinding? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddExpenseNewBinding.inflate(getLayoutInflater())
      ...
      /*  binding!!.cancelExpense.setOnClickListener(View.OnClickListener {
        ...
        binding!!.anc.setOnClickListener(View.OnClickListener {
            val i = Intent(this@AddExpenseNew, ManageCatActivity::class.java)
            startActivity(i)
    ...
    private fun createExpense() {
        ...
        FirebaseFirestore
            ...
            .document(expenseId)
            .set(expenseModel)
        Toast.makeText(this@AddExpenseNew, "Added", Toast.LENGTH_SHORT).show()
        finish()
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right)
    }
